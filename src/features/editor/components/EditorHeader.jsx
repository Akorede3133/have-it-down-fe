...
import { showPublish } from '../../../redux/EditorSlice';
  ...
  return (
    <header className="flex justify-between items-center py-2">
      ...
      <div className='flex gap-3 items-center'>
        <button className="bg-green-600 py-[2px] px-3 rounded-full text-white text-sm" onClick={() => dispatch(showPublish())}>publish</button>
